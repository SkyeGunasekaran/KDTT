...
def train_val_loo_split_teacher(ictal_X, ictal_y, interictal_X, interictal_y, val_ratio):
    '''
...
def train_val_test_split_teacher(ictal_X, ictal_y, interictal_X, interictal_y, val_ratio, test_ratio):
